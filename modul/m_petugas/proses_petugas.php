...
if ($_REQUEST['act'] == "save") {
    ...
    if ($query) {
        ...
        header('location:../../page.php?page=view_petugas');
    } else {
        $_SESSION['sweetalert'] = 'gagal_tambah';
        header('location:../../page.php?page=form_petugas&act=save');
    }
} else {
    ...
    if ($query) {
        ...
        header('location:../../page.php?page=form_petugas&act=edit&id=' . $_POST['id_petugas']);
    }
}
